...
<div class="container">
    <section id="primary" class="content-full-width">
        ...
        <ul class="products columns-4">
            <li
                class="product type-product post-14659 status-publish first instock product_cat-bath-furniture product_cat-wash-basin has-post-thumbnail shipping-taxable product-type-external">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><a class="image"
                                    href="#" title="Bath Tub"><img
                                        width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-1-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                                        srcset="{{ url('wp-content/uploads/sites/12/2018/05/product-1-300x300.jpg')}} 300w, {{ url('wp-content/uploads/sites/12/2018/05/product-1-150x150.jpg')}} 150w, {{ url('wp-content/uploads/sites/12/2018/05/product-1-768x768.jpg')}} 768w, {{ url('wp-content/uploads/sites/12/2018/05/product-1-600x600.jpg')}} 600w, {{ url('wp-content/uploads/sites/12/2018/05/product-1-100x100.jpg')}} 100w, {{ url('wp-content/uploads/sites/12/2018/05/product-1.jpg')}} 1000w"
                                        sizes="(max-width: 300px) 100vw, 300px" /><img width="1000" height="1000"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-11.jpg')}}"
                                        class="secondary-image attachment-shop-catalog" alt="" loading="lazy"
                                ...
                                <div class="product-buttons-wrapper">
                                    <div class="wc_inline_buttons">
                                        <div class="wc_cart_btn_wrapper wc_btn_inline"><a
                                                href="//mercantile.wordpress.org/product/wordpress-pennant/"
                                                data-quantity="1"
                                                class="dt-sc-button too-small button product_type_external"
                                                data-product_id="14659" data-product_sku="wp-pennant"
                                                aria-label="Buy on the WordPress swag store!" rel="nofollow">Buy on the
                                                WordPress swag store!</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class='product-details'>
                                <h5><a href="#">Bath Tub</a></h5>
                                <span class="product-price"><span class="price"><span
                                            class="woocommerce-Price-amount amount"><bdi><span
                                                    class="woocommerce-Price-currencySymbol">&#36;</span>11.05</bdi></span></span></span>
            ...
            <li
                class="product type-product post-45 status-publish outofstock product_cat-bath-furniture product_cat-showers has-post-thumbnail shipping-taxable product-type-variable">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><span class="out-of-stock"><span>Out of Stock</span></span><a
                                    ...
                                    title="Bathroom Hanger"><img width="300" height="300"
                                        ...
                                        sizes="(max-width: 300px) 100vw, 300px" /><img width="1000" height="1000"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-4.jpg')}}"
                                        class="secondary-image attachment-shop-catalog" alt="" loading="lazy"
            ...
            <li
                ...
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><span class="onsale"><span>Sale</span></span><a class="image"
                                    href="#"
                                    title="Double Flow Tab"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-5-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                                        ...
                                        sizes="(max-width: 300px) 100vw, 300px" /><img width="1000" height="1000"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-9.jpg')}}"
                                        class="secondary-image attachment-shop-catalog" alt="" loading="lazy"
                                ...
                                <div class="product-buttons-wrapper">
                                    <div class="wc_inline_buttons">
                                        <div class="wc_cart_btn_wrapper wc_btn_inline"><a href="#"
                                                data-quantity="1"
                            ...
                            <div class='product-details'>
                                <h5><a href="#">Double Flow
                                        Tab</a></h5><span class="product-price"><span class="price"><del
            ...
            <li
                class="product type-product post-60 status-publish last instock product_cat-faucets product_cat-showers product_cat-wash-basin has-post-thumbnail sale featured shipping-taxable purchasable product-type-simple">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><span class="onsale"><span>Sale</span></span>
                                <div class="featured-tag">
                                    ...
                                    title="Double Nozzle"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-12-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                            ...
                            <div class='product-details'>
                                <h5><a href="#">Double
                                        Nozzle</a></h5><span class="product-price"><span class="price"><del
                                            aria-hidden="true"><span class="woocommerce-Price-amount amount"><bdi><span
            ...
            <li
                class="product type-product post-62 status-publish first instock product_cat-faucets product_cat-showers product_cat-wash-basin has-post-thumbnail featured shipping-taxable purchasable product-type-simple">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'>
                                <div class="featured-tag">
                                    ...
                                    title="Dual Flow Tab"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-11-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                                        ...
                                        sizes="(max-width: 300px) 100vw, 300px" /><img width="1000" height="1000"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-3.jpg')}}"
                                        class="secondary-image attachment-shop-catalog" alt="" loading="lazy"
                            ...
                            <div class='product-details'>
                                <h5><a href="#">Dual Flow
                                        Tab</a></h5><span class="product-price"><span class="price"><span
                                            class="woocommerce-Price-amount amount"><bdi><span
            ...
            <li
                class="product type-product post-68 status-publish instock product_cat-faucets product_cat-hot-tubs has-post-thumbnail shipping-taxable purchasable product-type-simple">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><a class="image"
                                    ...
                                    title="Floor Touch Toilet"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-8-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                                        ...
                                        sizes="(max-width: 300px) 100vw, 300px" /><img width="1000" height="1000"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-12.jpg')}}"
                                        class="secondary-image attachment-shop-catalog" alt="" loading="lazy"
                                ...
                                <div class="product-buttons-wrapper">
                                    <div class="wc_inline_buttons">
                                        <div class="wc_cart_btn_wrapper wc_btn_inline"><a href="#"
                                                data-quantity="1"
                                                class="dt-sc-button too-small button product_type_simple add_to_cart_button ajax_add_to_cart"
                                                data-product_id="68" data-product_sku="woo-long-sleeve-tee"
                            ...
                            <div class='product-details'>
                                <h5><a href="#">Floor
                                        Touch Toilet</a></h5><span class="product-price"><span class="price"><span
                                            class="woocommerce-Price-amount amount"><bdi><span
                ...
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'>
                                <div class="featured-tag">
                                    ...
                                    title="Hand Shower Hose"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-9-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                                ...
                                <div class="product-buttons-wrapper">
                                    <div class="wc_inline_buttons">
                                        <div class="wc_cart_btn_wrapper wc_btn_inline"><a href="#"
                                                data-quantity="1"
                                                class="dt-sc-button too-small button product_type_simple add_to_cart_button ajax_add_to_cart"
                                                data-product_id="66" data-product_sku="woo-hoodie-with-zipper"
                            ...
                            <div class='product-details'>
                                <h5><a href="#">Hand Shower
                                        Hose</a></h5><span class="product-price"><span class="price"><span
                                            class="woocommerce-Price-amount amount"><bdi><span
            ...
            <li
                class="product type-product post-58 status-publish last instock product_cat-bath-furniture product_cat-hot-tubs product_cat-saunas has-post-thumbnail sale shipping-taxable purchasable product-type-simple">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><span class="onsale"><span>Sale</span></span><a class="image"
                                    ...
                                    title="Paper Holder"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-13-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                            ...
                            <div class='product-details'>
                                <h5><a href="#">Paper Holder</a>
                                </h5><span class="product-price"><span class="price"><del aria-hidden="true"><span
                                                class="woocommerce-Price-amount amount"><bdi><span
                        ...
                        <div class="product-wrapper">
                            <div class='product-thumb'><a class="image"
                                    ...
                                    title="Personal Shower"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-7-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                            ...
                            <div class='product-details'>
                                <h5><a href="#">Personal
                                        Shower</a></h5><span class="product-price"><span class="price"><span
                                            class="woocommerce-Price-amount amount"><bdi><span
                        ...
                        <div class="product-wrapper">
                            <div class='product-thumb'><span class="onsale"><span>Sale</span></span><a class="image"
                                    ...
                                    title="Pillar Tap"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-3-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                                        ...
                                        sizes="(max-width: 300px) 100vw, 300px" /><img width="1000" height="1000"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-17.jpg')}}"
                                        class="secondary-image attachment-shop-catalog" alt="" loading="lazy"
            ...
            <li
                class="product type-product post-73 status-publish instock product_cat-bath-furniture product_cat-wash-basin has-post-thumbnail downloadable virtual purchasable product-type-simple">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><a class="image"
                                    href="#"
                                    title="Rainfall Shower Head"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-6-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
                                        srcset="{{ url('wp-content/uploads/sites/12/2018/05/product-6-300x300.jpg')}} 300w, {{ url('wp-content/uploads/sites/12/2018/05/product-6-150x150.jpg')}} 150w, {{ url('wp-content/uploads/sites/12/2018/05/product-6-768x768.jpg')}} 768w, {{ url('wp-content/uploads/sites/12/2018/05/product-6-600x600.jpg')}} 600w, {{ url('wp-content/uploads/sites/12/2018/05/product-6-100x100.jpg')}} 100w, {{ url('wp-content/uploads/sites/12/2018/05/product-6.jpg')}} 1000w"
                                        sizes="(max-width: 300px) 100vw, 300px" /><img width="1000" height="1000"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-1.jpg')}}"
                                        class="secondary-image attachment-shop-catalog" alt="" loading="lazy"
                                ...
                                <div class="product-buttons-wrapper">
                                    <div class="wc_inline_buttons">
                                        <div class="wc_cart_btn_wrapper wc_btn_inline"><a href="#"
                                                data-quantity="1"
                                                class="dt-sc-button too-small button product_type_simple add_to_cart_button ajax_add_to_cart"
                                                data-product_id="73" data-product_sku="woo-album"
                                                aria-label="Add &ldquo;Rainfall Shower Head&rdquo; to your cart"
                                                rel="nofollow">Add to cart</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class='product-details'>
                                <h5><a href="#">Rainfall
                                        Shower Head</a></h5><span class="product-price"><span class="price"><span
                                            class="woocommerce-Price-amount amount"><bdi><span
                                                    class="woocommerce-Price-currencySymbol">&#36;</span>15.00</bdi></span></span></span>
                                <div class="product-rating-wrapper"></div>
                            </div>
                        </div> <!-- .product-wrapper -->
                    </div> <!-- .column -->
            ...
            <li
                class="product type-product post-44 status-publish last outofstock product_cat-faucets product_cat-hot-tubs product_cat-wash-basin has-post-thumbnail shipping-taxable product-type-variable">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><span class="out-of-stock"><span>Out of Stock</span></span><a
                                    ...
                                    title="Rectangle Wash Basin"><img width="300" height="300"
                                        data-src="{{ url('wp-content/uploads/sites/12/2018/05/product-18-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image" alt=""
                                        loading="lazy"
        ...
        <div class="pagination">
            <div class="column one pager_wrapper">
                <ul class='page-numbers'>
                    ...
                    <li><a class="next page-numbers" href="#">Next<i
