@extends('base')
@section('title') Wash Basin @endsection
@section('header')
<!-- ** Breadcrumb ** -->
<section class="main-title-section-wrapper breadcrumb-left">
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            ...
            <span class="fa default"></span>
            <span class="current">Wash Basin</span>
        </div>
    </div>
</section>
<!-- ** Breadcrumb End ** -->
...
<div class="container">
    <section id="primary" class="content-full-width">
        ...
        <ul class="products columns-4">
                    ...
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><a class="image"
                                    href="#"
                                    title="Bath Tub"><img width="300" height="300"
                                        src="{{ url('wp-content/uploads/sites/12/2018/05/product-1-300x300.jpg')}}"
                                ...
                                <div class="product-buttons-wrapper">
                                    <div class="wc_inline_buttons">
                                        <div class="wc_cart_btn_wrapper wc_btn_inline"><a
                                                ...
                                                rel="nofollow">Buy on the WordPress swag store!</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class='product-details'>
                                <h5><a href="#">Bath
                                        Tub</a></h5><span class="product-price"><span
                                        class="price"><span
                        ...
                        <div class="product-wrapper">
                            <div class='product-thumb'><a class="image"
                                    ...
                                    title="Rainfall Shower Head"><img width="300" height="300"
                                        src="{{ url('wp-content/uploads/sites/12/2018/05/product-6-300x300.jpg')}}"
                                        class="attachment-shop_catalog size-shop_catalog wp-post-image"
                                        alt="" loading="lazy"
                            ...
                            <div class='product-details'>
                                <h5><a
                                        href="#">Rainfall
                                        Shower Head</a></h5><span class="product-price"><span
                                        class="price"><span
                                            class="woocommerce-Price-amount amount"><bdi><span
            ...
            <li
                class="product type-product post-46 status-publish last instock product_cat-bath-furniture product_cat-saunas product_cat-wash-basin has-post-thumbnail shipping-taxable purchasable product-type-simple">
                <div class="woo-type1">
                    <div class="column dt-sc-one-fourth">
                        <div class="product-wrapper">
                            <div class='product-thumb'><a class="image"
                            ...
                            <div class='product-details'>
                                <h5><a href="{{ url('product/water-heater/">Water
