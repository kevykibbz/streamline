                ...
                <div class="ml-auto d-flex align-items-center">
                    <nav>
                        <ol class="breadcrumb p-0 m-b-0">
                            ...
                            <li class="breadcrumb-item active text-primary" aria-current="page">Add Admin</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-xl-6 mx-auto">
            <div class="card card-statistics">
                ...
                <div class="card-body"> 
                    <form class="SubmitForm" method="post" action="{{isset($admin)? '/edit/admin/'.$admin->id:''}}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">               
                            ...
                            <input type="email" class="form-control" name="email" value="{{isset($admin->email) ? $admin->email :''}}">
                            <div class="feedback"></div>
                        </div>
                        <div class="form-group">               
                            <label for="id_username">Username</label>
                            <input type="text" class="form-control" name="username" value="{{isset($admin->username) ? $admin->username :''}}">
                            <div class="feedback"></div>
                        </div>
                        <label for="id_phone">Phone</label>
                        <div class="form-group">               
                            <input type=tel class="form-control" name="phone" value="{{isset($admin->phone) ? $admin->phone :''}}">
                            <div class="feedback"></div>
                        </div>
                        @if(!isset($admin))
