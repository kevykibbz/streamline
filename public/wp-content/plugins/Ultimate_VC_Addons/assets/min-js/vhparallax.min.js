! function(e) {
        ...
        function a() {
            ...
            r.each(function() {
                ...
                if (!(r + o(e) < n || n + f < r)) {
                    ...
                    if (a = -a, jQuery(this).parent().hasClass("vcpb-mlvp-jquery")) var t = jQuery(this).parent().parent().data("img-parallax-mobile-disable").toString();
                    else t = jQuery(this).parent().data("img-parallax-mobile-disable").toString();
                    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) i = "true";
                    else var i = "false";
                    if ("true" == t && "true" == i) var l = "true";
                    else l = "false";
        ...
        function a() {
            ...
            r.each(function() {
                ...
                var e = jQuery(this),
                    r = e.offset().top;
                if (!(r + y(e) < o || o + f < r)) {
                    var a = jQuery(this).css("backgroundPosition"),
                        t = a.indexOf("px"),
                        i = a.substring(0, t),
                        l = 0;
                    ...
                    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) s = "true";
                    else var s = "false";
                    if ("true" == s && "true" == n) var u = "true";
                    else u = "false";
    ...
    jQuery(".vcpb-mlvp-jquery").each(function() {
        ...
        jQuery(e).find(".vertical_layer_parallax").css({
            "max-width": "none",
            position: "absolute"
        })
    }), jQuery(".vcpb-mlvp-jquery").each(function() {
        ...
        if (r = a / r, a = 0, "true" == i && "true" == e) var t = "true";
        else t = "false";
