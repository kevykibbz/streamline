! function(f) {
    ...
    function s(t, e, i) {
        if ("img" === i) {
            var r = (s = parseInt(e.outerHeight())) / 2;
            t.css("padding-top", r + "px"), t.parent().css("margin-top", r + 20 + "px"), e.css("top", -s + "px")
        } else {
            var s;
            r = (s = parseInt(e.outerHeight())) / 2;
            t.css("padding-top", r + "px"), t.parent().css("margin-top", r + 20 + "px"), e.css("top", -s + "px")
        }
    }

    function n(t) {
        0 < t.find(".timeline-icon-block").length && f(".timeline-block").each(function(t, e) {
            var i = f(this).find(".timeline-header-block"),
        ...
        jQuery(".ult-animation").each(function() {
            if (jQuery(this).attr("data-animate")) {
                var t = jQuery(this).children("*"),
                    ...
                    e = jQuery(this).attr("data-animation-duration") + "s",
                    i = jQuery(this).attr("data-animation-iteration"),
                    r = jQuery(this).attr("data-animation-delay"),
                    o = (jQuery(this).attr("data-opacity_start_effect"), "opacity:1;-webkit-animation-delay:" + r + "s;-webkit-animation-duration:" + e + ";-webkit-animation-iteration-count:" + i + "; -moz-animation-delay:" + r + "s;-moz-animation-duration:" + e + ";-moz-animation-iteration-count:" + i + "; animation-delay:" + r + "s;animation-duration:" + e + ";animation-iteration-count:" + i + ";"),
                    s = "opacity:1;-webkit-transition-delay: " + r + "s; -moz-transition-delay: " + r + "s; transition-delay: " + r + "s;";
                if (u(jQuery(this))) {
                    var n = jQuery(this).attr("style");
                    void 0 === n && (n = "test"), "opacity:0;" == (n = n.replace(/ /g, "")) && 0 !== n.indexOf(s) && jQuery(this).attr("style", s), jQuery.each(t, function(t, e) {
                        var i = jQuery(e),
                            r = i.attr("style");
                        void 0 === r && (r = "test");
                        var s = "";
                        s = 0 == r.indexOf(o) ? r : o + r, i.attr("style", s), u(i) && i.addClass("animated").addClass(a)
                    })
                }
            }
        })
    ...
    function a() {
        jQuery(".ult-new-ib").each(function(t, e) {
            var i = jQuery(this);
            if (i.hasClass("ult-ib-resp")) {
                var r = jQuery(document).width(),
                    s = i.data("min-width");
                r <= i.data("max-width") && s <= r ? i.find(".ult-new-ib-content").hide() : i.find(".ult-new-ib-content").show()
            }
        })
    }
    f.fn.vc_translate_row = function() {
        var c = f(window).scrollTop(),
            d = f(window).height();
        f(this).each(function(t, e) {
            var i = f(e).attr("data-row-effect-mobile-disable");
            if (i = void 0 === i ? "false" : i.toString(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) r = "true";
            else var r = "false";
            if ("true" == r && "true" == i) var s = "true";
            else s = "false";
            if ("false" == s) {
                var a = f(e).outerHeight(),
                    o = f(e).offset().top - c,
                    n = o + a,
                    u = f(e).attr("data-parallax-content-sense") / 100,
                    l = 0;
                if (n <= d - 0 * d && o <= 0) {
                    if (d < a) l = (d - n) * u;
                    else l = -o * u;
                ...
                f(e).find(".vc-row-translate-wrapper").children().each(function(t, e) {
                    jQuery(e).is(".upb_row_bg,.upb_video-wrapper,.ult-vc-seperator,.ult-easy-separator-wrapper") || f(e).css({
        ...
        f(this).each(function(t, e) {
            ...
            if ("false" == s) {
                var a = f(e).data("fadeout-percentage");
                a = 100 - a;
                var o = f(e).outerHeight(),
                    n = f(e).offset().top - d + o,
                    u = 1,
                    l = h - h * (a / 100),
                    c = (l - n) / l * 1;
                0 < c && (u = 1 - c), n <= l ? (u < 0 ? u = 0 : 1 < u && (u = 1), f(e).children().each(function(t, e) {
                    f(e).is(".upb_row_bg,.upb_video-wrapper,.ult-vc-seperator") || f(e).css({
                        opacity: u
                    })
                })) : f(e).children().each(function(t, e) {
                    f(e).css({
                        opacity: u
                    })
                })
        ...
        var u;
        u = "", f(".ult-spacer").each(function(t, e) {
            var i = f(e).data("id"),
                r = (f("body").width(), f(e).data("height-mobile")),
                s = f(e).data("height-mobile-landscape"),
                a = f(e).data("height-tab"),
                o = f(e).data("height-tab-portrait"),
                n = f(e).data("height");
            "" != n && (u += " .spacer-" + i + " { height:" + n + "px } "), "" == a && "0" != a && 0 != a || (u += " @media (max-width: 1199px) { .spacer-" + i + " { height:" + a + "px } } "), void 0 === o || "" == o && "0" != o && 0 != o || (u += " @media (max-width: 991px) { .spacer-" + i + " { height:" + o + "px } } "), void 0 === s || "" == s && "0" != s && 0 != s || (u += " @media (max-width: 767px) { .spacer-" + i + " { height:" + s + "px } } "), "" == r && "0" != r && 0 != r || (u += " @media (max-width: 479px) { .spacer-" + i + " { height:" + r + "px } } ")
        }), "" != u && (u = "<style>" + u + "</style>", f("head").append(u))
    }), jQuery(window).scroll(function() {
        var t = jQuery(".ult-no-mobile").length;
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && 1 <= t ? jQuery(".ult-animation").css("opacity", 1) : i(), f(".vc-row-fade").vc_fade_row(), f(".vc-row-translate").vc_translate_row()
        ...
        jQuery(".ult-banner-block-custom-height").each(function(t, e) {
            ...
            ("ontouchstart" in window || 0 < navigator.MaxTouchPoints || 0 < navigator.msMaxTouchPoints) && jQuery(this).find(".ult-new-ib-link").click(function(t) {
                ...
                var e = jQuery(this).attr("href"),
                    i = jQuery(this).data("touch-delay");
        ...
        jQuery(window).resize(function() {
            ...
            var e = parseInt(jQuery(this).width()),
                i = parseInt(jQuery(this).find(".timeline-block").width()),
                r = e - 2 * i - 40;
            r = r / e * 100, f(".jstime .timeline-wrapper").each(function() {
                jQuery(this).masonry({
                    itemSelector: ".timeline-block"
                })
            }), setTimeout(function() {
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && 1 <= e ? jQuery(".ult-animation").css("opacity", 1) : i(), a(), jQuery(".ubtn").on("mouseenter", function() {
            ...
            var e = "" != t.data("hover-bg") && t.data("hover-bg");
            setTimeout(function() {
            ...
            if (t.attr("style", i), "" != t.data("border-hover") && t.css("border-color", t.data("border-hover")), "none" != t.data("shadow-click")) {
            ...
            if (0 < jQuery(this).find(".aio-icon-img").length) {
                ...
                s(i, r, "img"), r.find(".img-icon").on("load", function() {
                    s(i, r, "icon")
                })
            } else {
                r = jQuery(this).find(".aio-icon");
                s(i, r, "icon"), jQuery(window).on("load", function() {
                    s(i, r, "icon")
                })
            }
        })
    ...
    function t() {
        jQuery(".ult-new-ib").each(function(t, e) {
            var i = jQuery(this).data("min-height") || "";
            jQuery(this).find(".ult-new-ib-img").data("min-height"), jQuery(this).find(".ult-new-ib-img").data("max-width");
            if ("" != i) {
                jQuery(this).addClass("ult-ib2-min-height"), jQuery(this).css("height", i), jQuery(this).find(".ult-new-ib-img").removeClass("ult-ib2-toggle-size");
                jQuery(this).find(".ult-new-ib-img").width();
                var r = jQuery(this).find(".ult-new-ib-img").height();
                (jQuery(this).width() <= i || r < i) && jQuery(this).find(".ult-new-ib-img").addClass("ult-ib2-toggle-size")
            }
    ...
    function i() {
        jQuery(".ultimate-map-wrapper").each(function(t, e) {
            ...
            var r = jQuery(e).find(".ultimate_google_map").attr("id"),
