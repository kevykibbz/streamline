...
class MemoryView extends Controller
{
    protected function get()
    {
    	$site=SiteConstants::all()[0];
        $unread=Contact::where('is_read',false)->count();
    	return view('admin.aboutpage',['path'=>'memory','unread'=>$unread,'site'=>$site,'title'=>'About memory section settings']);
    } 
    protected function edit(Request $request)
    {
    	...
    	return view('admin.aboutpage',['path'=>'memory','memory'=>$memory,'unread'=>$unread,'site'=>$site,'title'=>'About memory section settings']);
    } 
